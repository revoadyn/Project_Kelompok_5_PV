 ...
 * @author USER
 */
public class popup_layanan extends javax.swing.JFrame {
    private Connection conn = new koneksi().connect();
    private DefaultTableModel tabmode;
    public cucian_masuk layanan = null;

    /**
     * Creates new form popup_layanan
     */
    public popup_layanan() {
        initComponents();
    ...
    protected void datatable() {
        Object[] Baris = {"ID Layanan", "Layanan", "Estimasi Waktu", "Harga per Kg"};
    ...
    private void tblLayananMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tblLayananMouseClicked
        ...
        layanan.id_lay = tblLayanan.getValueAt(bar, 0).toString();
        layanan.jenis_lay = tblLayanan.getValueAt(bar, 1).toString();
        layanan.estimasi_waktu = tblLayanan.getValueAt(bar, 2).toString();
        layanan.hargaperkg = tblLayanan.getValueAt(bar, 3).toString();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(popup_layanan.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new popup_layanan().setVisible(true);
            }
        });
    }
